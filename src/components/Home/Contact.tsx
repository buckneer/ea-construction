      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Ready to start your construction project? Get in touch with our team for a consultation and quote.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            ...
            <form>
              ...
              <button
                type="submit"
                className="w-full bg-malachite-400 hover:bg-malachite-500 text-white py-3 px-6 rounded-lg transition duration-300 text-lg font-medium cursor-pointer whitespace-nowrap"
              >
                Send Message
              </button>
            </form>
          ...
          <div>
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center text-gray-600 hover:bg-malachite-400 hover:text-white transition duration-300"
                >
                  <FaFacebookF />
                </a>
                <a
